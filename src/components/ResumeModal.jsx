...
export default function ResumeModal({ onClose }) {
  ...
  const [includePhoto, setIncludePhoto] = useState(false); // Default to false for strict ATS compliance
      ...
      <div className="relative w-full max-w-4xl bg-white text-slate-900 rounded-2xl shadow-2xl overflow-hidden z-10 my-4 max-h-[95vh] flex flex-col resume-modal-container">
        ...
        <div className="p-6 sm:p-10 overflow-y-auto font-sans leading-normal bg-white text-slate-900 resume-document">
          ...
          <div className="text-center pb-3 mb-3 border-b-2 border-slate-900">
            {includePhoto && (
              <div className="mb-2 flex justify-center">
                <img
                  ...
                  alt="Divyanshu Sahu"
                  className="w-20 h-24 object-contain rounded border border-slate-300"
                />
              </div>
            )}
            
            <h1 className="font-heading font-black text-2xl sm:text-3xl text-slate-900 tracking-tight uppercase mb-1">
              {personal.name}
            </h1>
            ...
            <div className="text-xs text-slate-700 flex flex-wrap justify-center items-center gap-x-2 gap-y-1">
